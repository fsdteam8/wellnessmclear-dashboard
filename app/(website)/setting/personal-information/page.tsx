...
interface UserData {
  ...
  city: string;
  road: string;
  postalCode: string; // Changed to string to match API
  taxId?: string; // Made optional since it's not in API response
  profileImage: string;
  address?: string; // Added since API returns this
}
          ...
          <div className="bg-[#6459490D] p-6 rounded-[12px] relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                { label: "Road/Area", name: "road", span: true },
